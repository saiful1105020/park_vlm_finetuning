...
# Video,Question_ID,Question_Type,LLM_Model,LLM_Response,Processing_Time_Seconds,Total_Chunks,Has_Transcript,Has_Audio_JSON,Transcript_Length,Audio_JSON_Length,Prompt_Length,Prompt,Full_Transcript,Full_Audio_JSON
...
if __name__ == "__main__":
    ...
    # # V1 -- Chunk videos -> Generate chunk descriptions in JSON format -> Prompt GPT for question answering based on JSON descriptions
    
    # LLM_INPUT_FILES = [
    #     "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/parkinson_gpt_analysis_results.csv"
    # ]

    # LLM_OUTPUT_FILES = [
    #     "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/parkinson_gpt_analysis_results_with_likert.csv"
    # ]
    ...
    # # V2 -- Chunk videos -> Generate chunk descriptions in JSON format -> Prompt GPT for question answering based on JSON descriptions

    # LLM_INPUT_FILES = [
    #     "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_max fps32.csv"
    # ]

    # LLM_OUTPUT_FILES = [
    #     "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_with_likert.csv"
    # ]
    ...
    LLM_INPUT_FILES = [
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_2.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_3.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_4.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_5.csv"
    ]

    LLM_OUTPUT_FILES = [
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_2_with_likert.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_3_with_likert.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_4_with_likert.csv",
        "/localdisk1/PARK/park_vlm_finetuning/data/Chain_Of_View/llava_qwen_context_aware_responses_free_flow_5_with_likert.csv"
    ]
