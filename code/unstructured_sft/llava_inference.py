...
import sys 
# sys.path.append("/localdisk1/PARK/park_vlm_finetuning/code/data_processing/LLaVA-NeXT")  # Replace with the actual path to LLaVA-NeXT

# Redirect Huggingface cache to local disk (optional)
# mkdir -p /localdisk1/saiful_cache/{hf/{hub,transformers,datasets},tmp}
# export HF_HOME=/localdisk1/saiful_cache/hf
# export HF_HUB_CACHE=$HF_HOME/hub
# export TRANSFORMERS_CACHE=$HF_HOME/transformers
# export HF_DATASETS_CACHE=$HF_HOME/datasets
# export TMPDIR=/localdisk1/saiful_cache/tmp
